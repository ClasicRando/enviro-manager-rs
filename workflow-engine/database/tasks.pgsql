...
comment on table workflow_engine.tasks is 'All tasks executable by the workflow engine';
comment on column workflow_engine.tasks.task_id is 'Unique identifier for each task';
comment on column workflow_engine.tasks.name is 'Alias given to the task';
...
comment on constraint name_service_unq on workflow_engine.tasks is 'Ensures that for each service, a name is unique';
comment on constraint url_service_unq on workflow_engine.tasks is 'Ensures that for each service, a url extension is unique';

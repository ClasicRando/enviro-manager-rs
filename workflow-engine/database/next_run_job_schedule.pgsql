create function workflow_engine.next_run_job_schedule(
...
from (
    select time_since_start_of_week, start_of_week, start_of_next_week,
...
Arguments:
job_schedule:    Array of job schedule entries to find the next schedule entry
$$;

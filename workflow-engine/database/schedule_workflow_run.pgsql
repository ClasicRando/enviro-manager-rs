create or replace procedure workflow.schedule_workflow_run(
...
where
    ...
    and wr.status = 'Waiting'::workflow.workflow_run_status;
$$;

comment on procedure workflow.schedule_workflow_run IS $$

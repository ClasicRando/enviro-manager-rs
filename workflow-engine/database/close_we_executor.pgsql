...
where  wr.workflow_run_id = tq.workflow_run_id
...
Arguments:
executor_id:    ID of the exectuor to close
is_cancelled:   True if executor was a force shutdown and false if a graceful shutdown, default is false
$$;
